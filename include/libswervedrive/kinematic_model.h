...
public:
  ...
  std::pair<Nu, Lambda> computeChassisMotion(Lambda lambda_desired, double mu_desired, const Lambda& lambda_estimated,
                                             ...
                                             const double& k_lambda, const double& k_mu, const Eigen::VectorXd& beta);
  ...
  double estimateMu(const Lambda& lambda, const Eigen::VectorXd& phi_dot, const Eigen::VectorXd& beta);
  std::pair<double, double> muLimits(const Lambda& lambda, const Eigen::VectorXd& beta);
