...
public:
  ...
  std::pair<Nu, Lambda> computeChassisMotion(Lambda lambda_desired, double mu_desired, Lambda lamda_estimated,
  ...
  Xi computeOdometry(const Xi& xi, const Lambda& lambda, const double& mu, const double& dt);
